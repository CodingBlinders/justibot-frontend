...
const Chat = () => {
  ...
  return (
    <div className="grid grid-cols-12 overflow-hidden h-screen w-screen bg-[#131211]">
      <div className="sm:col-span-0 lg:col-span-2 md:col-span-3 p-4 justify-center items-center">
        <ChatNacBar />
      </div>
      <div className="col-span-12 lg:col-span-10 md:col-span-9 p-4 justify-center items-center w-full">
          ...
          <form className="relative h-full w-full">
            <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 mb-4 flex items-center justify-center w-full">
              <textarea
                ...
                onInput={handleInput}
              />
              <button className="flex items-center py-2 px-4 rounded-lg focus:outline-none focus:shadow-outline group">
                <svg
